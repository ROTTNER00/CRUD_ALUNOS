 ...
 * Generated at: 2024-11-06 14:39:56 UTC
    ...
    try {
      ...
      out.write("       ");
        ...
        if (request.getParameter("duracao") != null) {
            celular = request.getParameter("duracao");
        }
        ...
        try {
              ...
              pst.executeUpdate();
                        mensagem = "<p style='color:green;font-size:25px'>Música cadastrada com sucesso.</p>";
            ...
            if (erro.contains("Duplicate entry")) {
                mensagem = "<p style='color:blue;font-size:25px'>Música Cadastrada com sucesso.</p>";
            } else {
      ...
      out.write("\n");
      out.write("\n");
      out.write("    <form name=\"contactForm\" method=\"post\" action=\"\" onsubmit=\"return validateForm();\">\n");
      ...
      out.print( nome );
      out.write("\"><br>\n");
      out.write("        Duração: <input type=\"text\" name=\"celular\" value=\"");
      out.print( duracao );
      out.write("\"><br>\n");
